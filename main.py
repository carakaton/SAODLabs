...
from olympiad_files import olympiad_tasks
...
def main():
    ...
    olympiad = View('Олимпиадные задачи')
    olympiad_task_1 = View('Задача №1 — ', olympiad_tasks.task_1)
    olympiad_task_2 = View('Задача №2 — ', olympiad_tasks.task_2)
    olympiad_task_3 = View('Задача №3 — ', olympiad_tasks.task_3)
    olympiad.add_children(olympiad_task_1, olympiad_task_2, olympiad_task_3)
    ...
    start_screen.add_children(lab_1, lab_2, lab_3, lab_4, lab_5, lab_6, olympiad, final)
